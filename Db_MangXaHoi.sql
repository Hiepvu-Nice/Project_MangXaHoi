...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 08, 2023 lúc 07:14 PM
...
--
-- Cơ sở dữ liệu: `db_mangxahoi`
--
CREATE DATABASE IF NOT EXISTS `db_mangxahoi` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `db_mangxahoi`;
...
--
-- Cấu trúc bảng cho bảng `myaccount`
--
...
CREATE TABLE `myaccount` (
  ...
  `personalpages_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `personalpages`
--

CREATE TABLE `personalpages` (
  `id` int(11) NOT NULL,
  `introduce` varchar(5000) NOT NULL,
  `url_avatar` varchar(1000) NOT NULL,
  `url_background` varchar(1000) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `posts` (
  `id` int(11) NOT NULL,
  `newposts` varchar(5000) NOT NULL,
  `myaccount_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Chỉ mục cho bảng `personalpages`
--
ALTER TABLE `personalpages`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT cho bảng `myaccount`
--
ALTER TABLE `myaccount`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `personalpages`
--
ALTER TABLE `personalpages`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Cấu trúc bảng cho bảng `month_card`
--
...
--
-- Đang đổ dữ liệu cho bảng `month_card`
--
...
--
-- AUTO_INCREMENT cho bảng `month_card`
--
ALTER TABLE `month_card`
...
('root', '[{\"db\":\"db_mangxahoi\",\"table\":\"friend\"},{\"db\":\"db_mangxahoi\",\"table\":\"posts\"},{\"db\":\"db_mangxahoi\",\"table\":\"myaccount\"},{\"db\":\"db_mangxahoi\",\"table\":\"image\"},{\"db\":\"db_mangxahoi\",\"table\":\"personalpages\"},{\"db\":\"db_mangxahoi\",\"table\":\"account\"},{\"db\":\"doan_lthdt\",\"table\":\"location\"},{\"db\":\"doan_lthdt\",\"table\":\"admin\"},{\"db\":\"doan_lthdt\",\"table\":\"ticket\"},{\"db\":\"doan_lthdt\",\"table\":\"staff\"}]');
...
('root', '2023-01-08 18:14:01', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"vi\"}');
